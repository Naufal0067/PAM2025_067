...
@Composable
fun HomeGuruView(navController: NavController) {
    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text(
                        stringResource(R.string.home_guru),
        ...
        Column(
            ...
            // Welcome Section
            Text(
                text = "Halo, Guru!", // Anda bisa mengambil nama dari DB jika ada
                style = MaterialTheme.typography.headlineSmall,
                fontWeight = FontWeight.Bold
            )
            Text(
                text = "Pilih menu untuk mengelola pembelajaran",
